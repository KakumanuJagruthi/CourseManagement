    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-white bg-opacity-80 p-8 rounded-lg shadow-md w-full max-w-md text-center">
            ...
            <p class="text-gray-700 mb-6">
                Thank you, <strong>${userName}</strong>, for registering. Your account has been successfully created.
            </p>
            
            <!-- Button to go to the homepage -->
            <a href="${pageContext.request.contextPath}/" class="w-full block bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-blue-700 transition duration-300">
                Go to Homepage
            </a>
        </div>
    </div>
